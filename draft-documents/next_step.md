...
On November 3rd and 4th, the Rebuilding the Web of Trust design workshop looked at the future of decentralized trust on the internet with the goal of producing 3-5 white papers and specs. Those papers are now being polished up for release in December, leaving the question: what's next?

The biggest priority for the participants at the Web of Trust design workshop is to produce something notable for the 25th anniversary of PGP, in July 2016. This should be a working proof-of-concept that can help the Web of Trust to reach a broader audience. It should be something that's both _usable_ and _used_ and it needs to be _compelling_.
...
The white papers and specs produced at the design workshop are the first products of our new Web of Trust, and they can be the germ of our development. To start with, we've highlighted some additional papers that we think would draw everything together and help to tell our story. They include an article articulating the need for a new Web of Trust, explanatory introductions for some of our existing white papers, definitions of an agreed upon language, and possibly a few more use cases.
...
Whatever project is decided upon, we should keep in mind the following general principles:
...
* However, platforms won't get the public excited. For that you need a killer **app**. 
...
These smaller events would ultimately lead to a large get-together in July 2016, where 75 or so experts could celebrate the anniversary of PGP … and unveil the newest addition to the Web of Trust.

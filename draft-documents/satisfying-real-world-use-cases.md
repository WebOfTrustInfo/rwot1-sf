...
[[[I really don't know that this is TRUE - I don't believe there is research to prove this...networks by their nature lead to hyperconnected nodes HAVEING a lot of power. Look at all the work done about small scale networks and power laws and understanding what happened to the internet - where we are today is ALL power law networks and the power imbalances that creates - these type of thigns WILL happen in whatever new network thing we think we are creating.  It is a falicy to think otherwise. This is why I pulled ALL this text from the version I was working on yesterday - it is based on a bunch of assuptions that are NOT realistic. They are techno-utopian mumbo jumob.   Then there is also the issue of sort of casually referencing democracies as getting around these issues of power and control - Technological networks are not democracies either and I would argue that our current default picture of "democracy" being legislators elected by contintuancts is largely dominated by monied interestes ]]]
...
is why this aspect of the technology is what has been called a **web of trust.**
...
(medically)--in other words, persistent correlatable identifier - along with associated records.  An independent
